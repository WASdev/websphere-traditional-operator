...
type WebsphereTraditionalApplicationReconciler struct {
	client.Client
...
func (r *WebsphereTraditionalApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *WebsphereTraditionalApplicationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&appswebspheretraditionaliov1alpha1.WebsphereTraditionalApplication{}).
		Complete(r)
}
