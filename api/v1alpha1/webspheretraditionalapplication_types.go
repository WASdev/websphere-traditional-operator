...
func (cr *WebsphereTraditionalApplication) GetProbes() common.BaseComponentProbes {
...
func (cr *WebsphereTraditionalApplication) GetEnv() []corev1.EnvVar {
	return cr.Spec.Env
}

// GetEnvFrom returns slice of environment variables from source
func (cr *WebsphereTraditionalApplication) GetEnvFrom() []corev1.EnvFromSource {
...
func (ss *WebsphereTraditionalApplicationStatefulSet) GetStorage() common.BaseComponentStorage {
	if ss.Storage == nil {
		return nil
	}
	return ss.Storage
...
func (cr *WebsphereTraditionalApplication) GetMonitoring() common.BaseComponentMonitoring {
...
func (cr *WebsphereTraditionalApplication) GetStatefulSet() common.BaseComponentStatefulSet {
...
func (cr *WebsphereTraditionalApplicationStatefulSet) GetStatefulSetUpdateStrategy() *appsv1.StatefulSetUpdateStrategy {
	return cr.UpdateStrategy
}
...
func (a *WebsphereTraditionalApplicationAutoScaling) GetMinReplicas() *int32 {
	return a.MinReplicas
}

// GetMaxReplicas returns maximum replicas
func (a *WebsphereTraditionalApplicationAutoScaling) GetMaxReplicas() int32 {
...
func (s *WebsphereTraditionalApplicationStorage) GetSize() string {
	return s.Size
}

// GetMountPath returns mount path for persistent volume
func (s *WebsphereTraditionalApplicationStorage) GetMountPath() string {
	return s.MountPath
}

// GetVolumeClaimTemplate returns a template representing requested persistent volume
func (s *WebsphereTraditionalApplicationStorage) GetVolumeClaimTemplate() *corev1.PersistentVolumeClaim {
...
func (cr *WebsphereTraditionalApplication) GetServiceability() *WebsphereTraditionalApplicationServiceability {
	return cr.Spec.Serviceability
}

// GetSize returns pesistent volume size for Serviceability
func (s *WebsphereTraditionalApplicationServiceability) GetSize() string {
	return s.Size
}
...
func (m *WebsphereTraditionalApplicationMonitoring) GetLabels() map[string]string {
	return m.Labels
}

// GetEndpoints returns endpoints to be added to ServiceMonitor
func (m *WebsphereTraditionalApplicationMonitoring) GetEndpoints() []prometheusv1.Endpoint {
	return m.Endpoints
}
